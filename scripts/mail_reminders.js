...
async function checkAndSendReminders() {
    ...
    if (!JSONBIN_KEY || !EMP_BIN_ID || !SMTP_USER || !SMTP_PASS || !FIREBASE_PROJECT_ID) {
        console.error("CRITICAL: Missing required environment variables (JSONBIN_KEY, EMP_BIN_ID, SMTP_USER, SMTP_PASS, or FIREBASE_PROJECT_ID).");
        process.exit(1);
    }
